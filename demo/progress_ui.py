...
NODE_SPECS: tuple[tuple[str, str, str], ...] = (
    ...
    ("color_verify", "understand", "Validate ambiguous color"),
    ("material_verify", "understand", "Validate ambiguous material"),
    ...
    ("attribute_llm", "understand", "Extract shopping constraints"),
