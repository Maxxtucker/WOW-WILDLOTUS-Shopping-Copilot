...
NODE_SPECS: tuple[tuple[str, str, str], ...] = (
    ("casefold", "understand", "Casefold"),
    ("color_map", "understand", "Color map"),
    ("material_map", "understand", "Material map"),
    ("color_verify", "understand", "Color LLM"),
    ("material_verify", "understand", "Material LLM"),
    ("merge_rewrite", "understand", "Rewrite"),
    ("category_l1", "understand", "Category L1"),
    ("category_l2", "understand", "Category L2"),
    ("category_l3", "understand", "Category L3"),
    ("category_cap", "understand", "Category cap"),
    ("attribute_llm", "understand", "Attributes"),
    ("repair_1", "understand", "Repair 1"),
    ("repair_2", "understand", "Repair 2"),
    ("repair_3", "understand", "Repair 3"),
    ("disclosure", "understand", "Disclosure"),
    ("turn_delta", "understand", "Turn delta"),
    ("override_l1", "router", "Override L1"),
    ("override_l2", "router", "Override L2"),
    ...
    ("probe_before", "router", "Probe before"),
    ("apply_delta", "router", "Accumulate"),
    ("probe_after", "router", "Probe after"),
    ("route_llm", "router", "Route LLM"),
