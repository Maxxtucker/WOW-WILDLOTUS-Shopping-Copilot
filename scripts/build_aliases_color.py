...
from catalog_preprocess.eval_maps import BASE_TO_EVAL, EVAL_COLORS
from catalog_preprocess.text import fold_key
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=ROOT / "scripts" / "catalog_preprocess" / "aliases" / "color_aliases.json",
    )
