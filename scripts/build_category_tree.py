...
from catalog_preprocess.category_parents import build_parent_index
from catalog_preprocess.text import categories_list, category_tag_forms, fold_category, normalize_canonical

OUT = ROOT / "scripts" / "catalog_preprocess" / "aliases" / "category_tree.json"
PARENTS_OUT = ROOT / "scripts" / "catalog_preprocess" / "aliases" / "category_parents.json"
