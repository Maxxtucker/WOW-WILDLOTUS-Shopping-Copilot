# Load src/assets/nlu.env into this PowerShell session. Does not write user/system env.
# Contest zip:  . .\load_nlu_env.ps1
# Kit:          . .\scripts\load_nlu_env.ps1  (forwards here)
# Then: python nlu_console.py

$ErrorActionPreference = "Stop"
$EnvFile = Join-Path $PSScriptRoot "src\assets\nlu.env"
